 ...
 */
function wds_acme_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'wds_acme_remove_default_customizer_sections', 15 );
 ...
 * @author WebDevStudios
 */
function wds_acme_customize_scripts() {
	wp_enqueue_script( 'touchstonesfse-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
add_action( 'customize_preview_init', 'wds_acme_customize_scripts' );
