 ...
 */
function wds_acme_display_scaffolding_section( $args = [] ) {
	...
	$allowed_tags = wds_acme_scaffolding_allowed_html();
	...
	<div class="tab">
		...
		<div class="scaffolding-document-content tab-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'touchstonesfse' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'touchstonesfse' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'touchstonesfse' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'touchstonesfse' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'touchstonesfse' ); ?>:</strong></p>
 ...
 */
function wds_acme_scaffolding_allowed_html() {
 ...
 */
function wds_acme_display_global_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
 ...
 * @author JC Palmes
 */
function wds_acme_theme_scaffolding_nav() {
	?>
	<nav class="scaffolding-nav">
		<span><?php echo esc_html__( 'Scroll to:', 'touchstonesfse' ); ?></span>
		<a href="#globals" class="link"><?php echo esc_html__( 'Globals', 'touchstonesfse' ); ?></a>
		<a href="#typography" class="link"><?php echo esc_html__( 'Typography', 'touchstonesfse' ); ?></a>
		<a href="#media" class="link"><?php echo esc_html__( 'Media', 'touchstonesfse' ); ?></a>
		<a href="#icons" class="link"><?php echo esc_html__( 'Icons', 'touchstonesfse' ); ?></a>
		<a href="#buttons" class="link"><?php echo esc_html__( 'Buttons', 'touchstonesfse' ); ?></a>
		<a href="#forms" class="link"><?php echo esc_html__( 'Forms', 'touchstonesfse' ); ?></a>
		<a href="#elements" class="link"><?php echo esc_html__( 'Elements', 'touchstonesfse' ); ?></a>
	</nav><!-- .scaffolding-nav -->
	<?php
}
 ...
 * @author Carrie Forde
 */
function wds_acme_hook_theme_scaffolding() {
	$template_dir = 'template-parts/scaffolding/scaffolding';

	wds_acme_theme_scaffolding_nav();
...
add_action( 'wds_acme_scaffolding_content', 'wds_acme_hook_theme_scaffolding' );
